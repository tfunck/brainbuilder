...
if __name__ == '__main__' :
    ...
    exclude=[ 'dpat', 'racl', 'epib', 'oxot', 'zm24', 'sch2']
    df = create_section_dataframe(subject_id, 'L', auto_dir, crop_dir, csv_fn, template_fn, ligands_to_exclude=exclude, clobber=True)
