...
minctracc -clobber -est_translation $m -source_mask $source -simplex 12 -step 6 6 6 -lsq3 /tmp/src_1_blur.mnc /tmp/tgt_1_blur.mnc /tmp/tfm_1_1.xfm 

mincblur -clobber -fwhm 8 $source_lo /tmp/src_1
mincblur -clobber -fwhm 8 $target_lo /tmp/tgt_1
minctracc -clobber -transformation /tmp/tfm_1_1.xfm -step 4 4 4 -simplex 8 $m -lsq12  /tmp/src_1_blur.mnc /tmp/tgt_1_blur.mnc /tmp/tfm_1_2.xfm 

mincblur -clobber -fwhm 4 $source_lo /tmp/src_1
mincblur -clobber -fwhm 4 $target_lo /tmp/tgt_1
minctracc -clobber -transformation /tmp/tfm_1_2.xfm -step 2 2 2 -simplex 4 $m -lsq12 /tmp/src_1_blur.mnc /tmp/tgt_1_blur.mnc /tmp/tfm_1_3.xfm
...
cp /tmp/tfm_1_4.xfm $final_tfm
#mincblur -clobber -fwhm 1 $source /tmp/src_1
#mincblur -clobber -fwhm 1 $target /tmp/tgt_1
...
#minctracc -clobber -transformation /tmp/tfm_1_5.xfm -step 0.5 0.5 0.5 -simplex 1 $m -lsq12  /tmp/src_1_blur.mnc /tmp/tgt_1_blur.mnc /tmp/tfm_1_6.xfm

#cp /tmp/tfm_2_6.xfm $final_tfm
