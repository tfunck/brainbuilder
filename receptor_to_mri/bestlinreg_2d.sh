...
minctracc  $base -identity $step1 -simplex 2 -lsq6  /tmp/src_blur.mnc /tmp/tgt_blur.mnc $tfm1

# 2
mincblur -quiet -clobber  -3dfwhm $s2 -dimensions 2 $src /tmp/src
mincblur -quiet -clobber  -3dfwhm $s2 -dimensions 2 $tgt /tmp/tgt
minctracc  $base -transformation $tfm1 $step2 -simplex 1 -lsq9  /tmp/src_blur.mnc /tmp/tgt_blur.mnc $tfm2
