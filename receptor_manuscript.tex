...
\begin{tabular}{ | c | c | c | c | c | }
   \hline
    \textbf{Authors} & \textbf{Modality} & \textbf{Fully Automated} & \textbf{Blockface} & \textbf{3D reference} \\ \textbf{Species} \\ \hline
    Hibbard \cite{Hibbard1984} & AR & No & No & No &  Species \\
    Ourselin, et al \cite{Ourselin2001} & H  & No & No & No &  Species \\
    Maladain, et al \cite{Maladain2004} & AR  & Yes & No & Yes &  Rhesus Monkeys \\
    Dauget, et al \cite{Dauget2007} & H  & ? & Yes  & Yes  & Yes & Baboon \\
    Chakravarty, et al. \cite{Chakravarty2006} &  H & No & No & No & Species\\ 
    Cifor, et al. \cite{Cifor2011} &  H & No & No &  & Species\\ 
    Yang, et al. \cite{Yang2012} &  H & Yes & No & Yes & Mouse \\ 
    Schubert, et al. \cite{Schubert2016} & AR/H/PLI & Yes & No & Yes & MRI & Rat \\
    Iglesias, et al. \cite{Iglesias2018} & H & No & MRI & Human \\ 
    \hline
