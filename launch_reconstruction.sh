...
singularity exec -B "/data":"/data" ~/receptor-v.1.2.simg bash -c "python3.8 ~/projects/julich-receptor-atlas/launch_reconstruction.py $debug -o ${test_out_dir} -b $brain --hemi $hemisphere --batch-correction --mri-gm /data/receptor/human/mri1_R_gm_bg_srv.nii.gz --cortex-gm /data/receptor/human/mri1_gm_srv.nii.gz --ndepths 10 --surf-dir /data/receptor/human/civet/mri1/surfaces/ -r 4.0 3.0  2.0 1.0 0.5"
# 
